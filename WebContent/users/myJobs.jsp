		...
		<tr>
			<td align="center" valign="top" bgcolor="#FFFFFF" class="bg_qc">
				<table width="100%" height="27" border="0" cellpadding="8" cellspacing="0" bgcolor="#F6F6F6">
					<tr>
						<td align="left" class="p12">您的位置： <a href="<%=basePath%>">首页</a>&nbsp;&gt;&gt;&nbsp;我的招聘信息
						</td>
					</tr>
				</table>
						...
						<td align="left">
							<div class="z" id="z">
								<table width="99%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
									<tr>
										<td height="30" colspan="9" align="left" background="themes/nzblue/images/nzcms/list_bg.gif" class="white14B">我的招聘信息</td>
									</tr>
									<tr>
										<td align="center" bgcolor="#FFFFFF">标题</td>
										<td align="center" bgcolor="#FFFFFF">职业类型</td>
										<td align="center" bgcolor="#FFFFFF">招聘人数</td>
										<td align="center" bgcolor="#FFFFFF">报名人数</td>
										<td align="center" bgcolor="#FFFFFF">薪资</td>
									...
									<c:forEach items="${jobsList}" var="jobs">
										<tr align="center" bgcolor="#FFFFFF">
											...
											<td class="center">${jobs.catename}</td>
											<td class="center">${jobs.num}</td>
											<td class="center">${jobs.asignnum}</td>
											<td class="center">${jobs.salary}</td>
