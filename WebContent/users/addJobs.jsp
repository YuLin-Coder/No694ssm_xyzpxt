	...
	<table width="1004" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF">
		<tr>
			<td align="center" valign="top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="bg_qc">
					<tr>
						<td width="25" height="20" align="center"><img src="themes/nzblue/images/nzcms.xinxin.gif" alt="标" width="9"
							height="9" /></td>
						<td align="left" class="p12">您的位置： <a href="index.jsp">首页</a>&nbsp;&gt;&nbsp;&nbsp;发布招聘信息
						</td>
					</tr>
				</table>
				...
				<form action="index/addJobs.action" name="myform" method="post">
					<table width="66%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
						<tr>
							<td height="30" colspan="2" align="center" background="themes/nzblue/images/nzcms/list_bg.gif" class="white14B">发布招聘信息</td>
						</tr>
						<tr>
						...
						<tr>
							<td height="50" align="right" bgcolor="#FFFFFF">招聘人数：</td>
							<td bgcolor="#FFFFFF"><input type="text" name="num" style="width: 260px; height: 30px" required="required"
								id="num" placeholder="请输入招聘人数" /></td>
						</tr>

						<tr>
							<td height="50" align="right" bgcolor="#FFFFFF">招聘类型：</td>
						...
						<tr>
							<td height="50" align="right" bgcolor="#FFFFFF">薪水待遇：</td>
							<td bgcolor="#FFFFFF"><input type="text" name="salary" style="width: 260px; height: 30px"
								required="required" id="salary" placeholder="请输入薪水待遇" /></td>
						</tr>
						<tr>
