...
<body>
	<nav class="breadcrumb">
		...
		求职申请查询 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="6">求职申请查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">用户</th>
					<th class="center">招聘职位</th>
		...
		<div class="text-c">
			<form action="applys/queryApplysByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="jobsid">按招聘职位查询</option>
						<option value="addtime">按投递日期查询</option>
